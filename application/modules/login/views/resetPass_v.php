					...
					<div id="login-form-wrapper" class="no-animated">
						<form id="login-form" action="#" method="post">							
							...
							<div class="form-group">
								<input class="form-control" type="email" name="the_user_login" id="user_login" placeholder="Email Address" required="required" />
							</div><!-- /.form-group -->
							<div class="form-group">
								<input class="form-control" type="text" name="verification_code" id="verification_code" placeholder="Verification Code" required="required" />
							</div><!-- /.form-group -->
							<div class="form-group">
...
<script type="text/javascript" src="<?php echo base_url("assets/customScripts/restPassword.js"); ?>"></script>
<script type="text/javascript">
	$restUserURL = "<?php echo base_url("login/forgotPassword/resetUser");?>";
